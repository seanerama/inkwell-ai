...
CONTAINER_PREFIXES=("INKWELL_" "AGENT_" "SPACES_" "PUSH_" "BRAIN_")
...
main() {
  ...
  echo "ok: every INKWELL_/AGENT_/SPACES_/PUSH_/BRAIN_ key in .env.example is referenced in compose.yml"
